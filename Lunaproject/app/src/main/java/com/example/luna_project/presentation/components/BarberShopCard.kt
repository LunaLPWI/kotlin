...
import com.example.luna_project.data.models.FavoriteEstablishmentsDTO
import com.example.luna_project.data.session.SelectBarberSession
import com.example.luna_project.presentation.activities.BarberLocationActivity
...
fun BarberShopCard(
    ...
    Card(
        ...
        Column {
            ...
            Text(
                text = barbershop.addressDTO.formatAddress(),
                color = Color.Gray,
